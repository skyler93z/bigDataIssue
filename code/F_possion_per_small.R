...
save(F_type1error, file = paste0("result_F/F_type1/F_type1error_",kk,".rda"))
save(F_type1error.per, file = paste0("result_F/F_type1.per/F_type1error.per_",kk,".rda"))
save(F_type1error.per.de, file = paste0("result_F/F_type1.per.de/F_type1error.per.de_",kk,".rda"))
save(beta1.permu, file = paste0("result_F/F_beta1.permu/F_beta1.permu_",kk,".rda"))
save(CI, file = paste0("result_F/F_CI/F_CI_",kk,".rda"))
