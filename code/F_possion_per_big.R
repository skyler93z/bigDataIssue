...
save(p.value, file = paste0("result_F/F_p.value/F_p.value_",kk,"_",ss,".rda"))
save(p.value.per, file = paste0("result_F/F_p.value.per/F_p.value.per_",kk,"_",ss,".rda"))
save(decision, file = paste0("result_F/F_decision/F_decision_",kk,"_",ss,".rda"))
save(beta1.permu, file = paste0("result_F/F_beta1.permu/F_beta1.permu_",kk,"_",ss,".rda"))
save(CI, file = paste0("result_F/F_CI/F_CI_",kk,"_",ss,".rda"))
