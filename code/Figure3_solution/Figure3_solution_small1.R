...
save(type1error, file = paste0("result_fig3/solution_small1/type1error_",kk,".rda"))
save(type1error.per, file = paste0("result_fig3/solution_small1/type1error.per_",kk,".rda"))
save(type1error.per.de, file = paste0("result_fig3/solution_small1/type1error.per.de_",kk,".rda"))
save(beta1.permu, file = paste0("result_fig3/solution_small1/beta1.permu_",kk,".rda"))
save(CI, file = paste0("result_fig3/solution_small1/CI_",kk,".rda"))
