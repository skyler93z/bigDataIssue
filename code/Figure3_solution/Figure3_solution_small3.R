...
save(type1error, file = paste0("result_fig3/solution_small3/type1error_",kk,".rda"))
save(type1error.per, file = paste0("result_fig3/solution_small3/type1error.per_",kk,".rda"))
save(type1error.per.de, file = paste0("result_fig3/solution_small3/type1error.per.de_",kk,".rda"))
save(beta1.permu, file = paste0("result_fig3/solution_small3/beta1.permu_",kk,".rda"))
save(CI, file = paste0("result_fig3/solution_small3/CI_",kk,".rda"))
