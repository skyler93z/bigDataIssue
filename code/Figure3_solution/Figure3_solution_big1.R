...
save(p.value, file = paste0("result_fig3/solution_big1/p.value_",kk,"_",ss,".rda"))
save(p.value.per, file = paste0("result_fig3/solution_big1/p.value.per_",kk,"_",ss,".rda"))
save(decision, file = paste0("result_fig3/solution_big1/decision_",kk,"_",ss,".rda"))
save(beta1.permu, file = paste0("result_fig3/solution_big1/beta1.permu_",kk,"_",ss,".rda"))
save(CI, file = paste0("result_fig3/solution_big1/CI_",kk,"_",ss,".rda"))
