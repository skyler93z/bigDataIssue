...
save(p.value, file = paste0("./scnario2/result/solution_p.value/p.value_",kk,"_",ss,"_",gg,".rda"))
save(p.value.per, file = paste0("./scnario2/result/solution_p.value.per/p.value.per_",kk,"_",ss,"_",gg,".rda"))
save(decision, file = paste0("./scnario2/result/solution_decision/decision_",kk,"_",ss,"_",gg,".rda"))
save(beta1.permu, file = paste0("./scnario2/result/solution_beta1.permu_big/beta1.permu_",kk,"_",ss,"_",gg,".rda"))
save(CI, file = paste0("./scnario2/result/solution_CI_big/CI_",kk,"_",ss,"_",gg,".rda"))
