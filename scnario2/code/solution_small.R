...
save(typeIerror, file = paste0("./scnario2/result/solution_typeI/typeIerror_",kk,"_",ss,".rda"))
save(typeIerror.per, file = paste0("./scnario2/result/solution_typeI.per/typeIerror.per_",kk,"_",ss,".rda"))
save(typeIerror.per.de, file = paste0("./scnario2/result/solution_typeI.per.de/typeIerror.per.de_",kk,"_",ss,".rda"))
save(beta1.permu, file = paste0("./scnario2/result/solution_beta1.permu_small/beta1.permu_",kk,"_",ss,".rda"))
save(CI, file = paste0("./scnario2/result/solution_CI_small/CI_",kk,"_",ss,".rda"))
